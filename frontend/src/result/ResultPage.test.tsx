...
describe("ResultPage", () => {
  ...
  it("renders data-only dashboard blocks and verbatim response labels", () => {
    ...
    expect(html).toContain('class="persona-headline-badges"')
    expect(html).toContain('class="persona-headline-badge"')
    expect(html).toContain('class="persona-meta-badges"')
    expect(html).toContain('class="persona-meta-badge"')
    expect(html).toContain("응답자 #0")
    expect(html).toContain("27세")
    expect(html).toContain("경기 파주시")
    expect(html).toContain("무직")
    expect(html).toContain("3세대 동거")
    expect(html).toContain('class="response-signal concern"')
    expect(html).toContain('class="response-signal complaint"')
    expect(html.indexOf('class="response-signal complaint"')).toBeLessThan(html.indexOf('class="persona-meta-badges"'))
    expect(html).toContain("우려")
    expect(html).toContain("예상 민원")
    expect(html).toContain("입장 근거")
    expect(html).toContain("월세 부담을 낮춰줘서 필요합니다.")
